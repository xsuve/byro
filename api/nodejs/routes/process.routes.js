...
module.exports = (app) => {
  ...
  // Get all Process
  app.get('/processes', [verifyAccessToken], processController.getProcesses);
  ...
  app.delete('/process-drafts/:id/process-fields-values', processController.deleteDraftFieldsValues);
  ...
  app.get('/process-drafts/:id/process-fields-values', processController.getDraftFieldsValuesByDraftId);
  ...
  app.post('/processes/:id/process-fields-values', processController.createProcessFieldValue);


  // Get Process Documents
  app.get('/processes/:id/process-documents', processController.getProcessDocuments);

  // User Has Process Document
  app.get('/processes/users/:userId/process-documents/:documentTypeId', processController.userHasProcessDocument);

  // Complete Process
  app.post('/processes/complete', processController.completeProcess);

  // Update Process Field Value
  app.put('/process-fields-values/:id', processController.updateProcessFieldValue);
};
